...
function css() {
  ...
  //переводит scss => css
    ...
    //фильтрует и переносит меди запросы в конец файла
    .pipe(groupmediaqueries())
    //добавляет автопрефиксы для различных браузеров(кроссбраузерность)
    .pipe(
      autoprefixer({
